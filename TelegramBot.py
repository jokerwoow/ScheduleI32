...
def text(message):
	...
	dictt={'петришина':'Любомир Богданович(старший)\nМихайло Любомирович(молодший)','ровінського':'Віктор Анатолієвич','мазуренка':'Віктор Володимирович','стинську': 'Вікторія Володимирівна','косаревича':'Ростислав Ярославович','костишин':'Любов Павлівна','гречаник':'Наталія Юріївна','горєлова':'Віталій Олевтинович'}
	for i in today:
